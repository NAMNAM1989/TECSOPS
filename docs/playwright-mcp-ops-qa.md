...
2. **Đăng Nhập TCS** — form user/pass → tab TCS; nếu CAPTCHA không OCR được → nhập tay trên tab portal, không bắt buộc agent headed.
3. **Quét** — chỉ khi Ext đã Đăng Nhập TCS; cập nhật lô chưa HT tiếp nhận đúng kho đang chọn.
...
6. **Đổi kho** — TECS-TCS ↔ TCS: bắt Đăng Nhập TCS lại đúng user; không dùng chung session giả định.
...
- Không dùng MCP làm đường Đăng Nhập TCS/Quét/Điền/PDF thay Ext trong sản xuất.
