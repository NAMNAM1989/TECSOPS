...
export const MOBILE = {
  ...
  card: "relative overflow-clip rounded-lg border border-ui-border/80 bg-ui-surface",
  ...
  awb: "font-shipment-data text-[14px] font-extrabold leading-tight tracking-tight tabular-nums text-ui-danger",
