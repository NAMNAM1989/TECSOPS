/**
 * Bridge Ops ↔ Ext kho TCS — handshake chuẩn TECSOPS Ops↔Ext.
 *
 * Envelope:
 ...
 *   (job)      — TCS_OPEN / TCS_BOOTSTRAP / TCS_SCAN_DATE / FILL_ESID / …
 *   result     — trả về cùng `id`, `ok: true|false`
 *   error      — `ok: false` + `error` code (TIMEOUT phía Ops; EXT_* phía bridge)
 *
 * Channel: tecsops-tcs-direct-ext
 * @see docs/ops-ext-protocol.md
 */

const CHANNEL = "tecsops-tcs-direct-ext";
const PORTAL_WAREHOUSE = "TCS";
const EXT_LABEL = "kho TCS";
