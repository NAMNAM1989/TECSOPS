...
export function StatusPill({
  ...
  return (
    <span
      ...
      className={`inline-flex max-w-full items-center gap-1 truncate rounded-full border px-2.5 py-0.5 text-[10px] font-bold shadow-ui-sm ${statusSelectSurface[status]} ${className}`}
    >
