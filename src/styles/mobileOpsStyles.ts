...
export const MOBILE = {
  ...
  card: "relative overflow-hidden rounded-lg border border-black/[0.06] shadow-dashboard-card transition-all dark:border-white/[0.08]",
  cardInner: "relative z-10 bg-transparent px-2 py-1.5 transition-transform duration-200 ease-out",
  cardMeta: "truncate text-[10px] leading-tight text-apple-secondary dark:text-slate-400",
  customerName:
    "truncate text-[12px] font-bold leading-tight text-red-800 dark:text-red-300",
  awb: "font-mono text-[13px] font-extrabold leading-none tracking-tight text-red-900 dark:text-red-400",
