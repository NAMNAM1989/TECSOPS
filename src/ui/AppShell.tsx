...
/** Khung trang tối giản — sticky chrome Round 3 (mobile thấp hơn). */
export function AppShell({
  ...
  return (
    <div className={`mx-auto min-w-0 ${maxWidthClass} px-2.5 py-1 sm:px-3 sm:py-1.5 lg:px-4`}>
      <div className="sticky top-0 z-40 -mx-2.5 mb-1 min-w-0 border-b border-ui-border/80 bg-ui-background/94 px-2.5 pb-1 pt-[max(0.15rem,env(safe-area-inset-top))] backdrop-blur-[6px] sm:-mx-3 sm:mb-1.5 sm:px-3 sm:pb-1.5 sm:pt-1 lg:-mx-4 lg:px-4">
        {chrome}
      </div>
