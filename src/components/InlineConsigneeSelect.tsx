...
export function InlineConsigneeSelect({ value, options, disabled, onChange }: Props) {
  ...
  return (
    <select
      ...
      className="max-w-full min-w-0 cursor-pointer rounded border border-black/[0.08] bg-white px-0.5 py-px text-[10px] font-medium leading-tight text-apple-label focus:outline-none focus:ring-1 focus:ring-apple-blue/40 disabled:cursor-default disabled:opacity-60 dark:border-white/15 dark:bg-ops-bg dark:text-zinc-100 dark:focus:ring-sky-400/40"
    >
